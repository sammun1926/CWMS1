        ...
        <div class="carousel">
            <div class="container-fluid">
                <div class="owl-carousel">
                    ...
                    <div class="carousel-item">
                        <div class="carousel-img">
                            <img src="img/download 2.jpg" alt="Image">
                        </div>
                        <div class="carousel-text">
                    ...
                    <div class="carousel-item">
                        <div class="carousel-img">
                            <img src="img/download 3.jpg" alt="Image">
                        </div>
                        <div class="carousel-text">
                ...
                <div class="row align-items-center">
                    ...
                    <div class="col-lg-6">
                        ...
                        <div class="about-content">
                            <p>
                            Located in the vibrant city of Mombasa, specifically in the Kisauni area, our carwash offers a top-notch and convenient service for local residents and visitors alike. With a prime location that caters to the needs of vehicle owners, we provide professional car washing and detailing services to keep vehicles looking their best. Our skilled team uses eco-friendly products and modern equipment to ensure a thorough and environmentally responsible cleaning process. We pride ourselves on efficiency, quality, and customer satisfaction, making us the go-to choice for maintaining the cleanliness and shine of your vehicle in Kisauni, Mombasa.                            </p>
                            <ul>
                    ...
                    <div class="col-md-4">
                        <div class="price-item">
                            <div class="price-header">
                                ...
                                <h2><span>Ksh</span><strong>300</strong><span></span></h2>
                            </div>
                    ...
                    <div class="col-md-4">
                        <div class="price-item featured-item">
                            <div class="price-header">
                                ...
                                <h2><span>Ksh</span><strong>500</strong><span></span></h2>
                            </div>
                            <div class="price-body">
                                <ul>
                                    <li><i class="far fa-check-circle"></i>Seats Washing</li>
                    ...
                    <div class="col-md-4">
                        <div class="price-item">
                            <div class="price-header">
                                ...
                                <h2><span>Ksh</span><strong>1000</strong><span></span></h2>
                            </div>
                            <div class="price-body">
                                <ul>
                                    <li><i class="far fa-check-circle"></i>Seats Washing</li>
...
<form method="post">   
  <p>
            <select name="packagetype" required class="form-control">
                ...
                <option value="1">BASIC CLEANING (Ksh300)</option>
                 <option value="2">PREMIUM CLEANING (Ksh500)</option>
                  <option value="3 ">COMPLEX CLEANING(Ksh1000)</option>
              </select>
...
<?php } ?>
            ...
            <p><input type="text" name="carno" class="form-control"   required placeholder="Car NumberPlate"></p>
